...
public class Controller {
    ...
    public void initialize() {
        ...
        //Add items
        Main.albums.add(new MusicAlbum("A01","Defiance","Soundtrack",true,24));
        Main.albums.add(new MusicAlbum("A02","Insomniac","Punk Rock",true,14));
        Main.albums.add(new MusicAlbum("A03","A Great Day For The...","Gypsy Jazz",false,10));
        Main.albums.add(new MusicAlbum("A04","Viva La Internet","Ska",false,31));
        Main.albums.add(new MusicAlbum("A05","New Surrender","Rock",false,17));
        Main.albums.add(new MusicAlbum("A06","Swipe Right for Vintage","Swing",false,12));
        Main.albums.add(new MusicAlbum("A07","Coco Part 2","Swing",false,13));
    ...
    private void populateTable() {
        ObservableList<MusicAlbum> data = FXCollections.<MusicAlbum>observableArrayList(Main.albums);
    ...
    private void saveData(ActionEvent event) {
        try {
            ...
            for (MusicAlbum album : Main.albums) {
